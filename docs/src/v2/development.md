...
**Recommended versions:** PostgreSQL 18.4+ and Redis v8.8+ (Redis Open Source).
...
</details> <details> <summary><strong>GitHub Codespaces</strong></summary>
...
You should see at least Bun 1.3.14 (last checked: July 27th, 2026).
...
<details open>
<summary><strong>Linux (Ubuntu / Debian) and Github Codespaces</strong></summary>
...
Visit the repo at [https://github.com/TaskMinder/TaskMinder](https://github.com/TaskMinder/TaskMinder) and fork it.
